...
Serves predictions using a trained Decision Tree model
"""
...
app = FastAPI(
    ...
    description="A REST API for predicting Titanic passenger survival using Decision Tree Classifier",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)

# Configure CORS for frontend usage - allow all origins
app.add_middleware(
    CORSMiddleware,
...
MODEL_PATH = Path(__file__).parent.parent / "model" / "decision_tree_model.joblib"
model = None
